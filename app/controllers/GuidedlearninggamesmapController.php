...
class GuidedlearninggamesmapController extends \Phalcon\Mvc\Controller {
    ...
    /**
     * This function using to GuidedLearningGamesMap information edit
     */
    public function update($id = null) {
        ...
        if (empty($id)):
            ...
            $validation->add('guided_learning_schedule_id', new PresenceOf(['message' => 'guided_learning_schedule_idis required']));
            $validation->add('games_tagging_id', new PresenceOf(['message' => 'games_tagging_idis required']));
            $messages = $validation->validate($input_data);
            if (count($messages)):
                foreach ($messages as $message):
                    $result[] = $message->getMessage();
